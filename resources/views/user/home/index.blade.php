                                ...
                                <form action="{{ route('userHome') }}" method="GET">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="searchKey" value="{{ request('searchKey') }}"
                                            class="form-control" placeholder="Enter to search">
                                        <button type="submit" class="btn bg-dark text-white"><i
                                                class="fa-solid fa-magnifying-glass"></i></button>
                                    </div>
                                    <input type="number" name="minPrice" value="{{ request('minPrice') }}"
                                        class="form-control mt-3" placeholder="Minimum Price">
                                    <input type="number" name="maxPrice" value="{{ request('maxPrice') }}"
                                        class="form-control mt-3" placeholder="Maximum Price">
                                    <input type="submit" name="searchKey" value="Search"
                                        class="form-control w-100 bg-light rounded-pill active mt-3">
                                </form>
                                <form action="{{ route('userHome') }}" method="GET">
                                    @csrf
                                    <select name="sortingType" class="form-control mt-3">
                                    ...
                                    <input type="submit" class="form-control w-100 bg-light rounded-pill active mt-3"
                                        value="Sort">
                                </form>
                            </div>
                            <div class="col-9">
                                        ...
                                        <div class="col-md-6 col-lg-4 ">
                                            <div class="rounded position-relative fruite-item border border-secondary">
                                                ...
                                                <div class="text-white bg-secondary px-3 py-1 rounded position-absolute"
                                                    style="top: 10px; left: 10px;">{{ $items->categories_name }}</div>
                                                <div>
                                                    <div class="p-4 border-top-0 rounded-bottom">
                                                        <h4>{{ $items->name }}</h4>
                                                        <p>{{ Str::words($items->description, 10, '...') }}</p>
                                                        <div class="d-flex justify-content-between flex-lg-wrap">
                                                            <p class="text-dark fs-5 fw-bold mb-0">{{ $items->price }} .
                                                                MMK
                                                            </p>
